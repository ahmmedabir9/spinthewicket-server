...
const catchOut = (matchData, ballData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let dataToUpdate = {
            $inc: {
                'liveData.balls': 1,
            ...
            $push: {
                ...
                [`innings.${matchData.liveData.inning}.battingOrder`]: (0, utils_1.getBatsmanStats)(matchData, 0, 1, 'CATCH'),
                [`innings.${matchData.liveData.inning}.partnerships`]: (0, utils_1.getPartnarship)(matchData, 0, 1),
                [`innings.${matchData.liveData.inning}.fallOfWickets`]: (0, utils_1.getFallOfWicket)(matchData, matchData.liveData.batsman.striker.id, 1),
            },
            'liveData.batsman.striker': null,
            'liveData.bowler': (0, utils_1.getBowlerStats)(matchData, 0, 1, 1),
