...
const lbw = (matchData, ballData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let dataToUpdate = {
            $inc: {
                'liveData.balls': 1,
            ...
            $push: {
                ...
                [`innings.${matchData.liveData.inning}.battingOrder`]: (0, utils_1.getBatsmanStats)(matchData, 0, 1, 'LBW'),
