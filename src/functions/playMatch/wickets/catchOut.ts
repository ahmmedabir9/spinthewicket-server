...
const catchOut = async (matchData: Partial<_IMatch_>, ballData: any, battingTeam: string, bowlingTeam: string, inning: string) => {
  try {
    let dataToUpdate = {
      $inc: {
      ...
      $push: {
        ...
        [`innings.${inning}.battingOrder`]: getBatsmanStats(matchData, 0, 1, battingTeam, bowlingTeam, 'CATCH'),
