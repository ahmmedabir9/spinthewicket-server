...
const oneRun = (matchData, ballData) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        let dataToUpdate = {
            $inc: {
            ...
            'liveData.batsman.nonStriker': (0, utils_1.getBatsmanStats)(matchData, 1, 1),
            'liveData.bowler': (0, utils_1.getBowlerStats)(matchData, 1, 1),
            'liveData.partnership': (0, utils_1.getPartnarship)(matchData, 1, 1),
            'liveData.freeHit': false,
            'liveData.runRate': (0, utils_1.getRunRate)(matchData, 1, 1),
            [`innings.${matchData.liveData.inning}.runRate`]: (0, utils_1.getRunRate)(matchData, 1, 1),
        };
