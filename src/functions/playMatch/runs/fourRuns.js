...
const fourRuns = (matchData, ballData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let dataToUpdate = {
            $inc: {
                'liveData.balls': 1,
            ...
            'liveData.batsman.striker': (0, utils_1.getBatsmanStats)(matchData, 4, 1),
            'liveData.bowler': (0, utils_1.getBowlerStats)(matchData, 4, 1),
            'liveData.partnership': (0, utils_1.getPartnarship)(matchData, 4, 1),
            'liveData.freeHit': false,
            'liveData.runRate': (0, utils_1.getRunRate)(matchData, 4, 1),
            [`innings.${matchData.liveData.inning}.runRate`]: (0, utils_1.getRunRate)(matchData, 4, 1),
        };
        if (matchData.liveData.inning === 'second' || matchData.liveData.inning === 'secondSuper') {
            dataToUpdate = Object.assign(Object.assign({}, dataToUpdate), (0, utils_1.getTargetUpdate)(matchData, 4, 1));
        }
